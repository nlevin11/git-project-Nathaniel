...
public abstract interface GitInterface {
     ...
     */
    void stage(String filePath)throws NoSuchAlgorithmException, IOException, ObjectsDirectoryNotFoundException;
     ...
     */
    void checkout(String commitHash) throws NoSuchAlgorithmException, IOException, ObjectsDirectoryNotFoundException;
}
